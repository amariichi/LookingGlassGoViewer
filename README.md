...
### [ファイルのダウンロード](https://github.com/amariichi/LookingGlassGoViewer/releases/tag/v1.3.2)
...
**V1.3:** Improve depth projection by reprojecting mesh vertices along camera FOV directions and linking slider ranges to HologramCamera settings.
...
### [Download Files](https://github.com/amariichi/LookingGlassGoViewer/releases/tag/v1.3.2)
